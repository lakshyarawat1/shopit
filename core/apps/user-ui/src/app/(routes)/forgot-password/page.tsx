          ...
          {step === 'email' && (
            <>
              <h3 className="text-3xl font-semibold text-center mb-2">
                Login to Shop<span className="text-blue-500">IT</span>
              </h3>
              ...
              <form onSubmit={handleSubmit(onSubmitEmail)}>
                ...
                <button
                  ...
                  className="w-full text-lg cursor-pointer bg-black text-white mt-4 py-2 rounded-lg hover:bg-gray-700 transition duration-200 ease-in-out"
                >
              ...
              <>
                ...
                <form onSubmit={handleSubmit(onSubmitPassword)}>
                  ...
                  <input
                    ...
                    className='w-full p-2 border border-gray-300 outline-0 rounded-lg mb-2'
                    {
                    ...register("password", {
